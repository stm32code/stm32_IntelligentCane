...
#endif
// 设备信息
#define PROID "smartdevice&k11q5DybyzE"															 // 产品ID
#define DEVID "k11q5DybyzE.smartdevice|securemode=2,signmethod=hmacsha256,timestamp=1741675960245|" // 设备ID
#define AUTH_INFO "7334c4905669f0cdbcd372b470921a4bef227e5893ad7c70891defaeac1f1972"						 // 鉴权信息

//#define PROID "634589"															 // 产品ID
//#define DEVID "1215487338" //设备id
//#define AUTH_INFO "5"


// MQTT主题 /broadcast/
#define S_TOPIC_NAME "/broadcast/k11q5DybyzE/test1" // 需要订阅的主题
#define P_TOPIC_NAME "/broadcast/k11q5DybyzE/test2" // 需要发布的主题
